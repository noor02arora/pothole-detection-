...
# print("Enter 0 for")
print("Enter 0 for Video Source or Camera number for camera input: ")
inp = int(input())
...
if inp == 0: 
    ...
    cap = cv.VideoCapture(inp - 1)
    print("Processing Live detection...")
...
g = geocoder.ip('me') #for gettign coordinates
